...
def load_dataset("D:\Sem4\ml\PROJECT\Coherence_bert_cls_embeddings.csv"):
...
file_path = "D:\Sem4\ml\PROJECT\Coherence_bert_cls_embeddings.csv"
target_column = "label"
...
print(train_cm)
print(train_precision, train_recall, train_f1)
